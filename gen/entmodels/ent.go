...
//	Aggregate(entmodels.As(entmodels.Sum(field1), "sum_field1"), (entmodels.As(entmodels.Sum(field2), "sum_field2")).
//	Scan(ctx, &v)
//
...
func (e *NotFoundError) Error() string {
	return "entmodels: " + e.label + " not found"
}
...
func (e *NotSingularError) Error() string {
	return "entmodels: " + e.label + " not singular"
}
...
func (e *NotLoadedError) Error() string {
	return "entmodels: " + e.edge + " edge was not loaded"
}
...
func (e ConstraintError) Error() string {
	return "entmodels: constraint failed: " + e.msg
}
